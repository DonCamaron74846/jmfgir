...
function start()
{
    document.getElementById("status").innerHTML = "Le ametsis átse odnahcucse. Rop rovaf, albah"
    recognition.start();
}
...
recognition.onresult = function(event) {
    ...
    document.getElementById("status").innerHTML = "La voz de reconocio como: " + content;
    if(content =="círculo") {
